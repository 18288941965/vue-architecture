<template>
  ...
  background-color: #F6F8FA;height: 100vh;" class="theme3-body">
    ...
    <div>
      <main style="height: calc(100vh - 20px);
      margin: 10px 0 10px 0;
      border: 1px solid #2963AC;
      background-color: rgba(10,44,82,0.6);
      backdrop-filter: blur(5px);
     ; border-radius: 12px;">

        <div style="border-bottom: 1px solid #2963AC;padding: 10px;display: flex;align-items: center;">
        ...
        <div  style="border-bottom: 1px solid #2963AC;padding: 20px 20px 5px 20px;">
...
.theme3-body{
  background-image: url("../../assets/theme3-bg.svg");
  width: 100vw;
  height: 100vh;
}
